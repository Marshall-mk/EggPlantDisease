...
def _model_history(model_info, cfg):
    ...
    plt.legend()
    plt.grid()
    plt.savefig(f"{cfg.model.history_path}precision.png", dpi=300, bbox_inches="tight")
    ...
    plt.legend()
    plt.grid()
    plt.savefig(f"{cfg.model.history_path}recall.png", dpi=300, bbox_inches="tight")
    ...
    plt.legend()
    plt.grid()
    plt.savefig(f"{cfg.model.history_path}f1_score.png", dpi=300, bbox_inches="tight")
